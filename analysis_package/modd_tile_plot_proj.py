...
def plot_proj_to_latlon_grid(lons, lats, data, 
    ...
    # Add this routine to draw gridlines at places I'm investigating..
...
def _create_projection_axis(projection_type, user_lon_0, lat_lim, subplot_grid, figure,
                            less_output,row=[],col=[],ind=[]):
    ...
    if projection_type == 'Mercator':
        if subplot_grid is not None:
            ax = figure.add_subplot(row, col, ind,
